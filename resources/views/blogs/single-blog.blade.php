...
@section('content')
    <section class="section section-lg bg-white">
        <!-- section wave-->
        {{--<section class="breadcrumbs-custom breadcrumbs-custom-svg bg-gray-darker">--}}
            {{--<div class="parallax-scene-js parallax-scene" data-scalar-x="5" data-scalar-y="10" style="transform: translate3d(0px, 0px, 0px); transform-style: preserve-3d; backface-visibility: hidden;">--}}
                {{--<div class="layer-01">--}}
                    {{--<div class="layer" data-depth="0.25" style="transform: translate3d(3.97491px, -11.5824px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: relative; display: block; left: 0px; top: 0px;"><img src="{{asset('images/parallax-scene-01-132x133.png')}}" alt="" width="132" height="133">--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="layer-02">--}}
                    {{--<div class="layer" data-depth=".55" style="transform: translate3d(8.7448px, -25.4813px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;"><img src="{{asset('images/parallax-scene-02-186x208.png')}}" alt="" width="186" height="208">--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="layer-03">--}}
                    {{--<div class="layer" data-depth="0.1" style="transform: translate3d(1.58996px, -4.63296px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;"><img src="{{asset('images/parallax-scene-03-108x120.png')}}" alt="" width="108" height="120">--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="layer-04">--}}
                    {{--<div class="layer" data-depth="0.25" style="transform: translate3d(3.97491px, -11.5824px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;"><img src="{{asset('images/parallax-scene-04-124x145.png')}}" alt="" width="124" height="145">--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="layer-05">--}}
                    {{--<div class="layer" data-depth="0.15" style="transform: translate3d(2.38495px, -6.94945px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;"><img src="{{asset('images/parallax-scene-05-100x101.png')}}" alt="" width="100" height="101">--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="layer-06">--}}
                    {{--<div class="layer" data-depth="0.65" style="transform: translate3d(10.3348px, -30.1143px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;"><img src="{{asset('images/parallax-scene-06-240x243.png')}}" alt="" width="240" height="243">--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
        {{--</section>--}}
                ...
                <div class="cell-md-10 cell-lg-8 cell-xl-6 sections-collapsable">
                    <article class="post-blog-article">
                        ...
                        <ul class="post-blog-article-meta group-xl">
                            <li>
                                <div class="box-inline"><span class="icon icon-md icon-primary mdi mdi-account"></span>{{trans('app.by')}}
